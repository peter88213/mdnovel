[![Download the latest release](docs/img/download-button.png)](https://github.com/peter88213/mdnovel/raw/main/dist/mdnovel_v0.9.1.pyzw)
...
Download the latest release [mdnovel_v0.9.1.pyzw](https://github.com/peter88213/mdnovel/raw/main/dist/mdnovel_v0.9.1.pyzw)

- Launch *mdnovel_v0.9.1.pyzw* by double-clicking (Windows/Linux desktop),
- or execute `python mdnovel_v0.9.1.pyzw` (Windows), resp. `python3 mdnovel_v0.9.1.pyzw` (Linux) on the command line.
...
The package is also available in zip format: [mdnovel_v0.9.1.zip](https://github.com/peter88213/mdnovel/raw/main/dist/mdnovel_v0.9.1.zip)

- Extract the *mdnovel_v0.9.1* folder from the downloaded zipfile "mdnovel_v0.9.1.zip".
