"""Provide a class for the mdnovel model.
...
from mdnvlib.model.nv_service import NvService
...
class NvModel(ModelBase):
    ...
    def save_project(self, filePath=None):
        """Write the mdnovel project file, and set "unchanged" status."""
